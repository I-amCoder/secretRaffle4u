...
class FrontendController extends Controller
{
    ...
    public function currencyread(Request $request)
    {
        
        $pageTitle = 'Manage Currency';
        $emptyMessage = 'No Currency found';
        $users = Currency::orderBy('id','desc')->paginate(getPaginate());
        return view('admin.currency.list', compact('pageTitle', 'emptyMessage', 'users'));

    }

    public function currencycreateForm(Request $request)
    {
    ...
    public function currencyeditForm(Request $request)
    {        
        $pageTitle = 'Edit Currency';
        $currency = Currency::find($request->id);
        return view('admin.currency.list', compact('currency', 'pageTitle'));
    }
    ...
    public function currencyedit(Request $request)
    {
        ...
        return redirect()->route('admin.currencies.read');
