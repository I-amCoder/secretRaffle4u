            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.win*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.win.index')}} ">
                                <a href="{{route('admin.win.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Make Draw')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.win.winners')}} ">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    ...
                    <div class="sidebar-submenu {{menuActive(['admin.report*', 'admin.referral.commissionLog', 'admin.bids'],2)}} ">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.referral.commissionLog')}} ">
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.bids')}}">
