    ...
    <div class="row mb-none-30">
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-44 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['bid']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Bids')</span>
                    </div>

                    <a href="{{ route('admin.bids') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-7 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['bidAmount']}}</span>
                        <span class="currency-sign">{{ $general->cur_text }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Bid Amount')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-35 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['winners']}}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Win')</span>
                    </div>

                    <a href="{{ route('admin.win.winners') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div><!-- dashboard-w1 end -->
        <div class="col-xl-3 col-lg-4 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--gradi-50 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['winAmount']}}</span>
                        <span class="currency-sign">{{ __($general->cur_text) }}</span>
                    </div>
                    <div class="desciption">
                        <span class="text--small">@lang('Total Win Amount')</span>
                    </div>
