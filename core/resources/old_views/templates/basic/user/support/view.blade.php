                    ...
                    <div class="card-header card-header-bg d-flex flex-wrap justify-content-between align-items-center">
                        <h5 class="card-title mt-0">
                            ...
                            @elseif($my_ticket->status == 3)
                                <span class="badge badge--secondary py-2 px-3">@lang('Closed')</span>
                            @endif
                                                ...
                                                <div class="row justify-content-between">
                                                    <div class="col-md-8">
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    <a href="javascript:void(0)" class="btn btn--base btn--custom btn-sm btn-round mt-1 addFile">
                                                    ...
                                                    <div class="col-md-3">
                                                        <button type="submit" class="btn btn--base btn--custom custom-success mt-1">
            ...
            <div class="modal-content section--bg">
                <form method="post" action="{{ route('ticket.reply', $my_ticket->id) }}">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn--base btn--custom btn-sm"><i class="fa fa-check"></i> @lang("Confirm")
                        </button>
                    </div>
                </form>
            </div>
