                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <form action="{{route('user.withdraw.submit')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        @elseif($v->type == "file")
                                            <div class="form-group">
                                                <div class="position-relative">
                                                    <input type="file" name="{{$k}}" id="inputAttachments" class="form--control custom--file-upload my-1" @if($v->validation == "required") required @endif/>
                                                    <label for="inputAttachments">@lang('Select') {{__($v->field_level)}}</label>
                                                </div>
                                    ...
                                    @endif
                                    <div class="form-group">
                                        <button type="submit" class="btn btn--base btn--custom mt-4 text-center">@lang('Confirm')</button>
                                    </div>
                                </form>
                            </div>
                        </div>
