...
<head>
    ...
    <title>Secret Raffle 4U – Download App</title>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Download the best apps!</h1>
	                        <p class="hero-paragraph"> Download these two app and enjoy the experience. You only have to set it up once and you good to go.</p>
	                        <div class="hero-cta"><a class="button button-shadow" href="{{ asset('apps/raffle.apk') }}" target="_blank">Secret Raffle 4U</a>{{--<a class="button button-primary button-shadow" href="{{ asset('apps/e-walet.apk') }}" target="_blanck">Expat e Wallet</a>--}}</div>
						</div>
						<div class="hero-app">
							...
							<img class="device-mockup" src="{{ asset('assets/dist/images/iphone-mockup.png') }}" alt="App preview">
                ...
                <div class="container-sm">
                    <div class="newsletter-inner section-inner">
                        <div class="newsletter-header text-center">
                            <h2 class="section-title mt-0"> Thank you </h2>
                            <p class="section-paragraph">Enjoy the experience on these two apps. If you have any issues or inquires, please feel to contact us through the app or through social media platforms on our main website.</p>
                        </div>
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                    ...
                    <div class="footer-copyright">&copy; @ 2022 Secret Raffle 4U, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
