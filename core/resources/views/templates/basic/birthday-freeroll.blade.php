        ...
        <div class="container">
            <div class="row">
                <div class="section_heading mb-5 text-center">
                    ...
                    <h3 style="vertical-align: middle;">Birthday Freeroll <br /> Payout Structure</h3>
    ...
    <div class="birthday_gift">
        <div class="container">
            <div class="content text-center">
                <img src="{{ asset('assets/images/birthday-freeroll.png') }}" class="mb-2 img-fluid" alt="">
                <h2>Birthday Freeroll</h2>
            </div>
        </div>
    </div>
            ...
            <div class="row g-4 align-items-center">
                <div class="col-lg-6">
                    <div class="raffle_img text-center">
                        <img src="assets/images/raffile.png') }}" class="img-fluid" alt="image">
                    </div>
                </div>
                <div class="col-lg-6">
