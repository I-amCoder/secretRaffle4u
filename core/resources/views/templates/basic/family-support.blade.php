...
@section('content')
    ...
    <div class="payout_structure mt-5">
        <div class="container">
            <div class="row">
                <div class="section_heading support mb-5 text-center">
                    <img src="{{ asset('assets/images/icon/horizontal-right.png') }}" class="img-fluid heading_arrow" alt="icon">
                    <h3 style="vertical-align: middle;">55,555 Monthly FAMILY sUPPORT <br /> Payout Structure</h3>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="lucky_draw">
                                                        <h5>0 Free Lucky Draw</h5>
                                                        <h5>0 Freeroll Ticket</h5>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
    ...
    <div class="birthday_gift">
        <div class="container">
            <div class="content text-center">
                <img src="{{ asset('assets/images/support.png') }}" class="mb-3" alt="">
                ...
                <div class="col-lg-6">
                    <div class="raffle_content">
                        <div class="site_title">
                            ...
                            <img src="assets/images/icon/horizontal-left.png') }}" class="heading_arrow" alt="icon">
                        </div>
                    </div>
                    <div class="info_list">
                        <ul>
            ...
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="img text-center">
                        <img src="assets/images/rules.png') }}" class="img-fluid" alt="image">
                    </div>
                </div>
            </div>
        </div>
