        ...
        <div class="container">
            <div class="row">
                <div class="section_heading mb-5 text-center">
                    ...
                    <h3 style="vertical-align: middle;"> 555 Daily Salary <br /> Payout Structure</h3>
    ...
    <div class="birthday_gift">
        <div class="container">
            <div class="content text-center">
                <img src="{{ asset('assets/images/salary.png') }}" class="mb-2" alt="">
                <h2>Daily Salary</h2>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="clock_wrapper text-center">
                ...
                <div class="section_heading">
                    ...
                    <img src="assets/images/icon/horizontal-left.png') }}" class="img-fluid heading_arrow" alt="icon">
