...
@section('content')
    ...
    <div class="payout_structure mt-5">
        <div class="container">
            <div class="row">
                <div class="section_heading mb-5 support text-center">
                    <img src="{{ asset('assets/images/icon/horizontal-right.png') }}" class="img-fluid heading_arrow" alt="icon">
                    <h3 style="vertical-align: middle;"> 55,555,555 FLUFFY SNOWY CHRISTMAS <br /> Payout Structure</h3>
    ...
    <div class="birthday_gift">
        <div class="container">
            <div class="content text-center">
                <img src="{{ asset('assets/images/christmas.png') }}" class="mb-3 img-fluid" alt="">
