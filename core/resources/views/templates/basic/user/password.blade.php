                        ...
                        <form class="register prevent-double-click" action="" method="post">
                            ...
                            <div class="row mt-4">
                                <div class="form-group col-sm-12">
                                    <label for="cpassword" class="col-form-label">@lang('Current Password'):</label>
                                    <input id="cpassword" type="password" class="form--control" name="current_password" required autocomplete="current-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row pt-5">
                                <div class="col-sm-12 text-center">
                                    <button type="submit" class="btn w-100 btn--base btn--custom">@lang('Change Password')</button>
                                </div>
                            </div>
                        </form>
                    </div>
