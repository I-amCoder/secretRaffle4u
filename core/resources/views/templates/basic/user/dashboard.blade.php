        ...
        <div class="mb-5">
            <div class="row d-flex justify-content-center">
                 <div class="bottom">
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-10">
                            <h2 class="raffle-cat">{{ $cat->title }}<img src="{{ asset('assets/images/icon/horizontal-left.png') }}" class="heading_arrow" alt=""></h2>
                        </div>
                    ...
                    <div class="col-xxl-3 col-xl-4 col-lg-4 col-sm-6">
                        <div class="game-card text-center bg_img" style="background-image: url('{{asset($activeTemplateTrue.'images/bg/card-bg.png')}}');">
                            ...
                            <p class="mt-2 text--base game-card__amount mt-4">
                                ...
                                {{-- $general->cur_sym }}{{ __(getAmount($phase->unit_price)) --}}
                            ...
                            @php
                                            ...
                                            @if($phase->status=0)
                                                <h2 class="text-center draw-text pt-md-4 pt-sm-2">The raffle draw in no more available</h2>
                                            @elseif($start_time > $now_)
                                            <!-- ===========================  coundown  =========================== -->
												<div style="color:#fff;">Buy Tickets in</div>
                                                <div style="font-size: 26px; color: #D4C07E;" id="cd100<?=$key;?>"></div>
												@php
                                            ...
                                            @elseif($end_time < $now_)
                                                <h2 class="text-center draw-text pt-md-4 pt-sm-2">Raffle game is over</h2>
                                            ...
                                            @else
                                                <h2 class="text-center draw-text pt-md-4 pt-sm-2">The raffle draw in no more available</h2>
                                            @endif
                            <a href="{{ route('raffle-draw-details',$phase->id) }}" class="btn btn--base btn--custom mt-4">@lang('Details')</a>
                        </div>
                    </div>
                    @endif
