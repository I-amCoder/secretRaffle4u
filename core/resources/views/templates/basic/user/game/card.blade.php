...
@section('content')
    ...
    <section class="pt-100 pb-100">.
        <div class="container">
            ...
            <form action="{{ route('user.game.cardBid') }}" method="post">
                @csrf

                <input type="hidden" name="game_id" value="{{ $phase->game->id }}">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-8">
                        <div class="all-number card-wrapper h-100">
                            <div class="row justify-content-center">
                                <div class="col-sm-5">
                                    <div class="card-single img1" id="notify1">
                                        <img src="{{asset($activeTemplateTrue.'images/card/card1.png')}}" alt="image">
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="card-single img2" id="notify2">
                                        <img src="{{asset($activeTemplateTrue.'images/card/card2.png')}}" alt="image">
                                    </div>
                                </div>
                            </div>
                        </div>
...
@push('script')
    <script type="text/javascript">
        (function ($) {
            "use strict";
            $('.img1').click(function () {
                $(this).addClass('opHalf');
                $('.img2').removeClass('opHalf');
                notifyAnimation(1);
                $(this).addClass('clicked');
                $('.img2').removeClass('clicked');
                $('input[name=user_choose]').val('Red');
            });
            $('.img2').click(function () {
                $(this).addClass('opHalf');
                $('.img1').removeClass('opHalf');
                notifyAnimation(2);
                $(this).addClass('clicked');
                $('.img1').removeClass('clicked');
                $('input[name=user_choose]').val('Black');
            });
            ...
            function notifyAnimation(id) {
                ...
                var notRef = document.getElementById(`notify${id}`);
                if (!$(`.img${id}`).hasClass('clicked')) {
                    notRef.animate(noti, {
                        duration: 300,
                        iterationCount: 1,
                        easing: 'linear',
