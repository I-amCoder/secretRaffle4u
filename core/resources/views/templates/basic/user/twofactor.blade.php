                ...
                @else
                    <div class="card section--bg">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mx-auto text-center">
                                <a href="#0" class="btn btn--base btn--custom btn-lg mt-3 mb-1" data-bs-toggle="modal" data-bs-target="#enableModal">@lang('Enable Two Factor Authenticator')</a>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="col-lg-6 col-md-6">
                <div class="card section--bg">
                    ...
                    <div class=" card-body">
                        ...
                        <a class="btn btn--base btn--custom mt-3" href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=en" target="_blank">@lang('DOWNLOAD APP')</a>
                    </div>
