            ...
            <div class="row justify-content-center">
                <div class="col-xl-5 col-lg-6 col-md-8">
                    <div class="account-wrapper text-center">
                        <h4 class="fw-bold mt-5">@lang('Please Verify Your Mobile to Get Access')</h4>
                        <p>@lang('Your Mobile Number'): <strong>{{auth()->user()->mobile}}</strong></p>
                        <form class="account-from mt-4 text-start" method="POST" action="{{route('user.verify.sms')}}">
                            @csrf

                            <div class="form-group">
                                <label>@lang('Verification Code')</label>
                                <input type="text" name="sms_verified_code" id="code" class="form--control" placeholder="@lang('Enter Code')">
                            </div>
                            ...
                            <div class="text-center col-lg-12">
                                <p>@lang('If you don\'t get any code'), <a
                                        ...
                                        class="forget-pass text--base"> @lang('Try again')</a></p>
                            </div>
                        </form>
                    </div>
                </div>
