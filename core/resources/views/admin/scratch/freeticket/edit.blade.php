...
@section('panel')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.free-ticket.update',['free_ticket'=>$free_ticket->id]) }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url({{ getImage('assets/images/game/'. $free_ticket->photo) }})">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name" name="title"
                                           value="{{ $free_ticket->name }}" requierd/>
                                </div>

                                <div class="form-group">
                                    <label>@lang('Price')<span>*</span></label>
                                    <input type="number" name="unit_price" class="form-control" placeholder="Unit price" value="{{ $free_ticket->unit_price }}" requierd  >
                                </div>
