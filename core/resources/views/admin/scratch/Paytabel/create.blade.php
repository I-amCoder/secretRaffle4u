...
.red-border{
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form action="{{ route('admin.paytable.store') }}" method="POST" enctype="multipart/form-data" id="paytable-form">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <select class="form-control" name="scratch_id" requierd>
						...
						<div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
									...
									@else
                                    <input type="number" min="0" step="1" name="paytable[{{$i}}][prize]" class="form-control paytable-prize-input" placeholder="Prize Available" value="{{ old('prize') }}" requierd  >
									@endif
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
									...
									@else
                                    <input type="number" min="0" step="1" name="paytable[{{$i}}][amount]" class="form-control paytable-amount-input" placeholder="amount" value="{{ old('amount') }}" requierd  />
									@endif
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input type="file" min="0" step="1" name="paytable[{{$i}}][image]" class="form-control paytable-prize-input" placeholder="Prize Available" value="{{ old('image') }}" requierd  >
                                </div>
                            </div>
                            {{--<div class="col-md-2">
                                <div class="form-group">
									...
									@else
                                    <input type="number" min="0" step="1" name="paytable[{{$i}}][first_count]" class="form-control paytable-prize-input" placeholder="First Count" value="0" requierd  >
									@endif
                                </div>
                            </div>--}}
                            <div class="col-md-2">
                                <div class="form-group">
									...
									@else
                                    <input type="number" min="0" step="1" name="paytable[{{$i}}][reset_count]" class="form-control paytable-prize-input" placeholder="Reset Count" value="0" requierd  >
									@endif
                                </div>
                            </div>
