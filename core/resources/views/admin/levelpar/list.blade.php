                ...
                <div class="card-body p-0">
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                            <tr>
                                <th>@lang('Level1 Par')</th>
                                <th>@lang('Level2 Par')</th>
                                <th>@lang('Level3 Par')</th>
                                <th>@lang('Level4 Par')</th>
                                <th>@lang('Level5 Par')</th>
                                <th>@lang('Action')</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            <tr>
                                ...
                                <td data-label="@lang('Action')">
                                    <a href="{{ route('admin.levelpar.detail', $user->id) }}" class="icon-btn" data-toggle="tooltip" title="" data-original-title="@lang('Details')">
