                        ...
                        <tbody>
                                ...
                                @foreach ($free_ticket_sets as $k => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" form="update_form_{{$item->id}}"  class="form-control mb-2" value="{{$item->free_scratch_cards}}" name="free_scratch_cards" required/>
                                        </td>
                                        <td>
                              ...
                              @csrf
                                <tr>
                                    <td>
                                        ...
                                        <td>
                                            <label class="float-left">Free Scratch Cards:</label>
                                            <input type="number" class="form-control mb-2"  name="free_scratch_cards"
                                                />
                                        </td>
