                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bottom_box_input" class="form-control" id="bottom_box_input" value="{{ $raffle->bottom_box_input }}" requierd >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bottom_box_input_2" class="form-control" id="bottom_box_input_2" value="{{ $raffle->bottom_box_input_2 }}" requierd >
                                </div>
                                        ...
                                        <table class="table raffle_info">
                                         ...
                                         <tbody>
                                            ...
                                            @foreach($game_info as $info )
                                             <tr>
                                                 <td>
                                                    <input type="text" name="game_info[]" class="form-control" requierd value="{{ $info }}">
                                                 </td>
                                                 <th>
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-info raffle_rule_more">Add More</button>
                                    </label>
                                    <div class="table">
                                        <table class="table raffle_rule">
                                         ...
                                         <tbody>
                                            ...
                                            @foreach($game_rules as $rule )
                                             <tr>
                                                 <td>
                                                    <input type="text" name="game_rules[]" class="form-control" requierd value="{{ $rule }}">
                                                 </td>
                                                 <th>
                                                     <button type="button" class="btn btn-outline-danger rule_close">X</button>
                                                 </th>
                                             </tr>
                                             @endforeach
                                             @endif
