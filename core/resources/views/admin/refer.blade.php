            ...
            <div class="card border--primary mt-2">
                ...
                <div class="card-body parent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if($general->dc == 0)
                                <a href="{{ route('admin.referral.status','dc') }}" class="btn btn--success btn-block mb-3">@lang('Enable Now')</a>
                            @else
                                <a href="{{ route('admin.referral.status','dc') }}" class="btn btn--danger btn-block mb-3">@lang('Disable Now')</a>
                            @endif
                        </div>
                    </div>
            ...
            <div class="card border--primary mt-2">
                ...
                <div class="card-body parent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if($general->ic == 0)
                                <a href="{{ route('admin.referral.status','ic') }}" class="btn btn--success btn-block mb-3">@lang('Enable Now')</a>
                            @else
                                <a href="{{ route('admin.referral.status','ic') }}" class="btn btn--danger btn-block mb-3">@lang('Disable Now')</a>
                            @endif
                        </div>
                    </div>
            ...
            <div class="card border--primary mt-2">
                ...
                <div class="card-body parent">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            @if($general->wc == 0)
                                <a href="{{ route('admin.referral.status','wc') }}" class="btn btn--success btn-block mb-3">@lang('Enable Now')</a>
                            @else
                                <a href="{{ route('admin.referral.status','wc') }}" class="btn btn--danger btn-block mb-3">@lang('Disable Now')</a>
                            @endif
                        </div>
                    </div>
